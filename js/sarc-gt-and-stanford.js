function sarc_gt_and_stanford() {
	
var svg = d3.select("#sarc-gt-and-stanford").append("svg"),
...
d3.json("./data/sarc-gt-and-stanford.json", function(error, dataObj) {
